...
snipedir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
sys.path.insert(0,snipedir) 

from snipe.pathomap.bowtie2wrapper import bowtie2Wrap
from snipe.utils import seqParse
...
def processPathoMap(pathoMapOptions):
	...
	for indexPrefix in procPathoMapOptions.targetIndexPrefixes:
		...
		if pathoMapOptions.verbose:
			prin("Creating bowtie2 alignment: " + bowtie2Options.outAlignFile)
